  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-8 py-8">
      ...
      <section className="mb-8">
        <div className="mb-6">
          <h2 className="text-3xl font-bold mb-3 text-white">Production Paths</h2>
          <p className="text-gray-400">Our fully ready and production learning paths</p>
        </div>
        ...
        {isLoadingPaths ? (
          ...
          <div className="text-center py-10">
            <p className="text-gray-500">No production paths are currently available. Check back soon!</p>
          </div>
        )}
      </section>
