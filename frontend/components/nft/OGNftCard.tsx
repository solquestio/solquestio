                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-3">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center mt-1">
                            <span className="text-sm text-gray-300 mr-1">Collection of 10,000</span>
                        ...
                        <div className="mt-2">
                            <Link href="/claim-og-nft" className="inline-block">
                                <button className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold py-2 px-6 rounded-sm transition-all duration-200 transform hover:scale-105 shadow-lg text-base">
                                    Mint FREE NFT
                                </button>
                            </Link>
                        </div>
