                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="mt-3">
                            <Link href="/claim-og-nft" className="inline-block">
                                <button className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold py-2 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg text-sm">
                                    Mint FREE NFT
                                </button>
                            </Link>
                        </div>
